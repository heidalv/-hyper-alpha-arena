...
from backend.services.kline_ai_analysis_service import analyze_kline_chart, get_analysis_history
...
def get_ai_analysis_detail(
    ...
    try:
        log = analytics_db.query(KlineAIAnalysisLog).filter(
