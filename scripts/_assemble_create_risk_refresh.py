"""Assemble strategy_creation, symbol_risk, refresh_positions modules."""
...
refresh = (
    ...
    ") -> tuple:\n"
    + dedent(load("_refresh_positions_body.tmp"))
    + "\n"
)
(FA / "refresh_positions.py").write_text(refresh, encoding="utf-8")
print("refresh_positions", len(refresh.splitlines()))
...
create = (
    ...
    + dedent(load("_try_create_from_template_body.tmp"))
    + "\n\n"
...
# --- symbol risk ---
cls = load("_per_symbol_risk_result.tmp")
# rename class
cls = cls.replace("class _PerSymbolRiskResult", "class PerSymbolRiskResult")
