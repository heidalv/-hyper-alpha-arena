...
interface TabsContentProps {
  ...
  children: React.ReactNode
  className?: string
  /** If true, unmount content when tab is not active (old behavior). Default: keep mounted. */
...
export function TabsContent({ value, children, className, forceUnmount }: TabsContentProps) {
  ...
  return (
    <div
      className={cn(
        'flex flex-col ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 min-h-0',
        className
      )}
