...
export default function PromptManager() {
  ...
  const handleAiWriteClick = () => {
    // 🔓 LOCAL UNLOCK: No login required
          ...
          <Card className="flex-1 flex flex-col h-full overflow-hidden">
            ...
            <CardContent className="flex flex-col gap-4 flex-1 overflow-hidden">
              ...
              <div className="flex-1 flex flex-col min-h-[400px]">
                ...
                <textarea
                  className="flex-1 w-full rounded-md border bg-background p-3 font-mono text-sm leading-relaxed focus:outline-none focus:ring-1 focus:ring-ring resize-none min-h-[360px]"
                  value={templateDraft}
